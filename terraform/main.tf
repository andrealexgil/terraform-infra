...
# AWS Infrastructure for Cloud Solutions Inc.
# Production-ready, scalable web application infrastructure
...
resource "aws_launch_template" "app" {
  ...
  user_data = base64encode(<<-EOF
              ...
              echo "<h1>Cloud Solutions Inc. Web App</h1>" > /var/www/html/index.html
...
resource "aws_db_instance" "main" {
  ...
  db_name  = "webapp"
  username = "admin"
  password = "ChangeMePlease123!" # In production, use AWS Secrets Manager
...
# CloudWatch policy for EC2 instances
